...
import { Segmented, Switch, Watermark, Button } from "antd";
...
import { CreateTraderRequest } from "@/types";
...
const GP = () => {
  ...
  return (
    <StrategyListWrapper>
      <Header>
        <div className="header-title">GP</div>
              ...
              <div className="StrategyList-list-item">
                ...
                <div className="StrategyList-list-item-action">
                  <div className="action-buttons">
                   ...
                   {!extendList.includes(item.vaultAddress) && 
                      <DownOutlined 
                        onClick={() => onExtend(item?.vaultAddress, false)} 
                        className="expand-icon" 
                      />
                    }
                    {extendList.includes(item.vaultAddress) && 
                      <UpOutlined 
                        onClick={() => onExtend(item?.vaultAddress, true)} 
                        className="expand-icon" 
                      />
                    }
                </div>
